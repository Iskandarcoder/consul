...
/**
 * InfoUzbSearch represents the model behind the search form about `backend\models\InfoUzb`.
 */
class InfoUzbSearch extends InfoUzb
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['uz_name', 'ru_name', 'en_name', 'x_name', 'link', 'icon'], 'safe'],
        ];
    }
