...
class CKEditor extends InputWidget
{
    ...
    protected function registerPlugin()
    {
        ...
        $options = $this->clientOptions !== false && !empty($this->clientOptions)
            ...
            : '{}';
        $jsVarCkeditor = 'ckeditor_'.str_replace('-', '_', $id);
        $js[] = "var {$jsVarCkeditor} = CKEDITOR.replace('$id', $options);";
        $js[] = "AjexFileManager.init({returnTo: 'ckeditor', editor: {$jsVarCkeditor}});";
